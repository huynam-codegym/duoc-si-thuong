...
- **Trạng thái tháng 9/2026:** chỉ khu Thực phẩm chức năng có sản phẩm thật — 6 sản phẩm: Blackmores Omega Double (giá tạm 450.000đ, ảnh còn là ảnh giữ chỗ), Cốm vi sinh Lacto Biomin Gold+, Feroglobin B12 viên, Osteocare viên, Siro Feroglobin B12, Siro Osteocare (5 sản phẩm sau đều của Vitabiotics — Anh, nhập bởi VE Pharma, nội dung lấy từ ảnh nhãn chủ website gửi, xem `docs/ghi-chu-kiem-duyet-san-pham.md`) — cùng 1 sản phẩm mẫu (`draft: true`, chỉ thấy khi `npm run dev`). Ba khu còn lại (Dược mỹ phẩm, Chăm sóc cá nhân, Thiết bị y tế) **chưa có sản phẩm nào**, hiện "Sản phẩm đang được cập nhật"; menu và trang nhóm đã có sẵn, chỉ cần thêm bài sản phẩm khi chủ website gửi thông tin.
