...
- **Trạng thái tháng 9/2026:** chỉ khu Thực phẩm chức năng có sản phẩm thật — 8 sản phẩm đã đăng: Blackmores Omega Double (giá tạm 450.000đ, ảnh còn là ảnh giữ chỗ), Cốm vi sinh Lacto Biomin Gold+, Feroglobin B12 viên, Osteocare viên, Siro Feroglobin B12, Siro Osteocare, Liveril (nhóm "Gan - Mật", số công bố 8719/2019/ĐKSP), Pregnacare Plus Omega-3 (nhóm "Vitamin tổng hợp", dual pack viên nén + viên nang Omega-3 cho mẹ bầu/mẹ cho con bú, số công bố 9184/2019/ĐKSP) — tất cả 7 sản phẩm sau đều của Vitabiotics (Anh), nhập bởi VE Pharma, nội dung lấy từ ảnh nhãn chủ website gửi, xem `docs/ghi-chu-kiem-duyet-san-pham.md` — cùng **1 sản phẩm cho trẻ em đang ở dạng nháp chờ duyệt** (Siro Wellbaby Multi-vitamin Liquid, `draft: true` dù đã có giá 412.000đ, vì ảnh nhãn phụ tiếng Việt gửi tới mờ không đọc rõ số công bố sản phẩm và đây là sản phẩm cho trẻ từ 4 tháng tuổi — cần dược sĩ xác nhận kỹ trước khi đăng, xem ghi chú) và 1 sản phẩm mẫu (`draft: true`, chỉ thấy khi `npm run dev`). Ba khu còn lại (Dược mỹ phẩm, Chăm sóc cá nhân, Thiết bị y tế) **chưa có sản phẩm nào**, hiện "Sản phẩm đang được cập nhật"; menu và trang nhóm đã có sẵn, chỉ cần thêm bài sản phẩm khi chủ website gửi thông tin.
