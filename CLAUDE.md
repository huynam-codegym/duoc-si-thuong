...
- **Trạng thái tháng 9/2026:** 9 bài (giảm đau/hạ sốt, kháng viêm, dạ dày, ho/cảm cúm, dị ứng, vitamin, huyết áp, đái tháo đường, đọc nhãn thuốc) đã đăng ở dạng **bản xem thử theo yêu cầu của chủ website**; đều do AI soạn, **chưa được kiểm duyệt**. Bài kháng sinh (`dung-khang-sinh-dung-cach`) vẫn là `draft: true` nên nhóm Kháng sinh đang trống. Nguồn chủ yếu là MedlinePlus, WHO, FDA; chưa có nguồn Việt Nam (Bộ Y tế, Dược thư quốc gia). Điểm cần dược sĩ kiểm tra: `docs/ghi-chu-kiem-duyet-nhom-thuoc.md`.
