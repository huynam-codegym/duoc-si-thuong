...
- **Biểu tượng nhỏ (emoji) trong menu thả xuống:** mỗi nhóm có trường `icon` trong `categories.ts` (mục "Xem tất cả bài viết" dùng 📚). Biểu tượng chỉ để trang trí (`aria-hidden`), chữ bên cạnh vẫn là tên nhóm. Nên dùng cùng emoji với ảnh đại diện của bài trong nhóm đó cho thống nhất. Emoji hiển thị hơi khác nhau tùy điện thoại/hệ điều hành.
